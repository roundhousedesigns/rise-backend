...
class Credit {
	 ...
	 * The credit's ID.
	 *
	 * @var int $credit_id The credit post ID.
	 * @since 0.1.0
	 */
	public $credit_id;
	 ...
	 * The credit title.
	 *
	 * @var string $title The credit title.
	 * @since 0.1.0
	 */
	private $title;
	 ...
	 *
	 * @var string $job_title The credit job title.
	 * @since 0.1.0
	 */
	private $job_title;
	 ...
	 * The credit location.
	 *
	 * @var string $job_location The credit job location.
	 * @since 0.1.0
	 */
	 ...
	 *
	 * @var string $work_start The credit's work_start meta field.
	 * @since 0.1.0
	 */
	private $work_start;
	 ...
	 *
	 * @var string $work_end The credit's work_end meta field.
	 * @since 0.1.0
	 */
	private $work_end;
	 ...
	 *
	 * @var boolean $work_current The credit's work_current meta field.
	 * @since 0.1.0
	 */
	...
	/**
	 * The credit's department `position` taxonomy terms.
	 *
	 * @var int[] $departments The credit's department position IDs.
	 * @since 1.0.9
	 */
	private $departments;

	/**
	 * The credit's job `position` taxonomy terms.
	 *
	 * @var int[] $jobs The credit's job position IDs.
	 * @since 0.1.0
	 */
	private $jobs;
	 ...
	 * @since  0.1.0
	 *
	 * @param  array  $data The credit's data.
	 * @return void
	 */
