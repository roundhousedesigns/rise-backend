/**
 * useFilteredJobPostIds hook. Query to retrieve job posts.
 */
...
const useFilteredJobPostIds = (filters: FilteredJobPostsParams = {}): [number[], any] => {
...
export default useFilteredJobPostIds;
