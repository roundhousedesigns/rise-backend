...
class Shortcodes {
	...
	private function init_hooks() {
		...
		add_shortcode( 'rise_lost_password_form', [$this, 'lost_password_form'] );
	}
	...
	*/
	public function lost_password_form( $attributes, $content = null ) {
		...
		if ( is_user_logged_in() ) {
			...
			error_log('fuck');
			ob_start();
			include RISE_PLUGIN_DIR . 'templates/lost-password-form.php';
			return ob_get_clean();
		}
	}
